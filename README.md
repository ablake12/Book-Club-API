# Book-Club-API
Hello. This is a RESTful API that manages a virtual Book Club using SQLite for storing and managing the data. Users can interact with this API through a User Interface or through Postman.
